...
# TICS Phase 1B - Regime Engine Configurations
...
# TICS Phase 1C.1 - Liquidity Event Engine Configurations
LIQUIDITY_EVENT_ENGINE_ENABLED = True
LIQUIDITY_EVENT_ENFORCEMENT_ENABLED = False
LIQUIDITY_EVENT_OUTPUT_DIR = os.path.join(
    BASE_DIR,
    "liquidity_event_artifacts",
)
